...
- **Additive migrations.** Schema changes are hand-written and applied with `prisma migrate deploy` – never `migrate dev`; regenerate the client and rebuild `@yarns/db`.
