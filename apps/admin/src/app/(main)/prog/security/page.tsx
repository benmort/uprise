        ...
        <div className="page-stack">
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-400">
              Manage your password, active sessions and account.
            </p>
          </div>
    ...
    <Card className={cardClass}>
      ...
      <CardContent>
        <form className="space-y-4" onSubmit={handleSubmit}>
          ...
          {feedback.error && (
            <Alert variant="error" title="Couldn't update password" message={feedback.error} />
          )}
          {feedback.success && (
            <Alert variant="success" title="Done" message={feedback.success} />
          )}
          <Button
            type="submit"
  ...
  return (
    <Card className={cardClass}>
      ...
      <CardContent className="space-y-4">
        {feedback.error && (
          <Alert variant="error" title="Error" message={feedback.error} />
        )}
        {feedback.success && (
          <Alert variant="success" title="Done" message={feedback.success} />
        )}
      ...
      <CardContent>
        {!sessionLoaded ? (
          ...
          <div className="space-y-4">
            ...
            />
            {feedback.error && (
              <Alert variant="error" title="Couldn't delete account" message={feedback.error} />
            )}
            {feedback.success && (
              <Alert variant="success" title="Done" message={feedback.success} />
            )}
