...
export default function SharedInboxDetailPage() {
      ...
      <div className="xl:col-span-9 w-full">
        <div className="rounded-2xl border border-border bg-surface p-10 text-center">
          ...
          <button
            ...
            className="inline-flex items-center gap-2 rounded-lg border border-border bg-surface px-3 py-2 text-sm font-medium text-foreground hover:bg-surface-variant"
          >
  ...
  return (
    <div className="xl:col-span-9 w-full">
      <div className="flex flex-col justify-between overflow-hidden rounded-2xl border border-border bg-surface xl:h-full">
        {/* Header */}
        <div className="flex flex-col justify-between border-b border-border sm:flex-row">
          <div className="flex items-center justify-between w-full gap-3 px-4 py-4 sm:justify-normal">
            <button
              onClick={() => router.push(backHref)}
              title="Back to shared inbox"
              className="flex h-10 w-full max-w-10 items-center justify-center rounded-lg border border-border bg-surface text-foreground/80 transition hover:bg-surface-variant hover:text-foreground"
            >
                  ...
                  <button
                    ...
                    className={`flex h-10 items-center gap-2 rounded-lg border px-3 text-sm font-medium transition ${
                      resolved
                        ...
                        : 'border-border bg-surface text-muted-foreground hover:bg-surface-variant'
                    }`}
                  >
          ...
          <div className="flex items-center justify-between w-full gap-4 px-4 py-3 border-t border-border sm:justify-end sm:border-t-0 sm:py-5">
            ...
            <div className="flex items-center justify-end gap-2">
              <button
                ...
                className="flex h-8 w-8 items-center justify-center rounded-lg border border-border bg-surface text-muted-foreground transition hover:bg-surface-variant disabled:cursor-not-allowed disabled:opacity-40"
              >
        ...
        <div className="flex items-center gap-3 border-b border-border px-5 py-4">
          <div className="w-11 h-11 overflow-hidden rounded-full bg-surface-variant flex items-center justify-center">
            <span className="text-lg font-semibold text-muted-foreground">{senderName.charAt(0).toUpperCase()}</span>
          </div>
          <div>
            <span className="mb-0.5 block text-sm font-medium text-foreground">{subject}</span>
    ...
    <>
      ...
      <div className="sticky bottom-0 border-t border-border bg-surface p-4">
        ...
        <div className="flex items-end gap-2">
          <textarea
            className="min-h-[52px] w-full rounded-lg border border-border bg-transparent p-3 text-sm text-foreground placeholder:text-muted-foreground/70 focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/10 disabled:opacity-50"
          ...
          <button
            ...
            className="flex h-11 shrink-0 items-center gap-2 rounded-lg bg-primary px-4 text-sm font-medium text-white hover:bg-primary/90 disabled:cursor-not-allowed disabled:opacity-50"
          >
