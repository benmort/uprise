...
import { ArrowLeft, Plug, PlusCircle, Webhook } from "lucide-react";
import {
...
export default function IntegrationsSettingsPage() {
  ...
  const rows = data ?? [];
  // baseUrl is mandatory for an internal source; the API key is optional on
  // update (blank keeps the stored key, since connections are keyed one-per-type).
  ...
  return (
    <div className="page-stack">
      <div className="flex items-center gap-2">
        ...
        {!noPermission ? (
          <Button className="ml-auto" onClick={openConnect}>
