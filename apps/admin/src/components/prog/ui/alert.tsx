...
/** Reusable Alert component. Supports light and dark modes. */
  ...
  return (
    ...
    >
      <div className="flex items-start gap-3">
        <div className={clsx("-mt-0.5 shrink-0", variantClasses[variant].icon)}>
          {icons[variant]}
        </div>
        ...
        <div className="min-w-0 flex-1">
          ...
          {children ?? (message != null && <p className="text-sm text-gray-500 dark:text-gray-400">{message}</p>)}
