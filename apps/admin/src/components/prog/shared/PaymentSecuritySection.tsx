    ...
    <section className="pt-10">
      <div className="mx-auto flex max-w-[584px] flex-col justify-center px-4 sm:px-5 xl:px-0">
        <div className="mx-auto mb-3 inline-flex max-w-max items-center">
          ...
          <p className="-tracking-0.28 ml-4 text-sm font-medium text-gray-600 dark:text-gray-400">
            Safe & secure payments, Powered by
          </p>
          <span className="mx-3 block h-4.5 w-px bg-gray-300 dark:bg-gray-700" />
          <Image
        ...
        <p className="-tracking-0.28 mb-8 text-center text-sm text-gray-600 dark:text-gray-400">
          We do not store any credit card information in server, payments are processed by gateways and site is secured by{" "}
          <span className="text-gray-800 dark:text-gray-200">128 bit SSL encryption.</span>
        </p>
        <p className="mb-5 text-center text-sm font-medium text-gray-600 dark:text-gray-400">
