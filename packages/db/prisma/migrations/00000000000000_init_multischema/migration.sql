...
-- CreateTable
CREATE TABLE "iam"."AppUser" (
    "id" TEXT NOT NULL,
    "organizationId" TEXT NOT NULL,
    "email" TEXT NOT NULL,
    "displayName" TEXT NOT NULL,
    "passwordHash" TEXT,
    "role" "iam"."AppUserRole" NOT NULL DEFAULT 'ORGANISER',
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
-- CreateIndex
CREATE INDEX "Contact_organizationId_gnafPid_idx" ON "Contact"("organizationId", "gnafPid");

-- CreateIndex
CREATE UNIQUE INDEX "AppUser_email_key" ON "iam"."AppUser"("email");

-- CreateIndex
CREATE INDEX "AppUser_organizationId_role_idx" ON "iam"."AppUser"("organizationId", "role");

-- CreateIndex
CREATE INDEX "Audience_organizationId_status_idx" ON "audience"."Audience"("organizationId", "status");

-- CreateIndex
CREATE INDEX "AudienceContact_organizationId_phoneE164_idx" ON "audience"."AudienceContact"("organizationId", "phoneE164");
...
-- CreateIndex
CREATE INDEX "AudienceImport_organizationId_status_createdAt_idx" ON "audience"."AudienceImport"("organizationId", "status", "createdAt");

-- CreateIndex
CREATE INDEX "Blast_organizationId_status_idx" ON "messaging"."Blast"("organizationId", "status");
...
-- CreateIndex
CREATE INDEX "InboundMessage_organizationId_threadKey_receivedAt_idx" ON "messaging"."InboundMessage"("organizationId", "threadKey", "receivedAt");
...
-- CreateIndex
CREATE INDEX "OutboundMessage_organizationId_toPhone_sentAt_idx" ON "messaging"."OutboundMessage"("organizationId", "toPhone", "sentAt");

-- CreateIndex
CREATE INDEX "OutboundMessage_contactId_idx" ON "messaging"."OutboundMessage"("contactId");

-- CreateIndex
CREATE INDEX "ContactConsent_organizationId_channel_state_idx" ON "messaging"."ContactConsent"("organizationId", "channel", "state");

-- CreateIndex
CREATE INDEX "ContactConsent_contactId_idx" ON "messaging"."ContactConsent"("contactId");

-- CreateIndex
CREATE UNIQUE INDEX "ContactConsent_organizationId_phoneE164_channel_key" ON "messaging"."ContactConsent"("organizationId", "phoneE164", "channel");

-- CreateIndex
CREATE UNIQUE INDEX "WhatsappTemplate_contentSid_key" ON "messaging"."WhatsappTemplate"("contentSid");

-- CreateIndex
CREATE INDEX "WhatsappTemplate_organizationId_status_idx" ON "messaging"."WhatsappTemplate"("organizationId", "status");

-- CreateIndex
CREATE INDEX "IntegrationConnection_organizationId_type_status_idx" ON "integration"."IntegrationConnection"("organizationId", "type", "status");

-- CreateIndex
CREATE INDEX "AnalyticsSnapshot_organizationId_metricName_bucketAt_idx" ON "analytics"."AnalyticsSnapshot"("organizationId", "metricName", "bucketAt");

-- CreateIndex
CREATE INDEX "ConversationState_contactId_idx" ON "messaging"."ConversationState"("contactId");

-- CreateIndex
CREATE INDEX "ConversationState_organizationId_ownerId_idx" ON "messaging"."ConversationState"("organizationId", "ownerId");

-- CreateIndex
CREATE UNIQUE INDEX "ConversationState_organizationId_contactPhone_channel_key" ON "messaging"."ConversationState"("organizationId", "contactPhone", "channel");

-- CreateIndex
CREATE INDEX "Script_organizationId_channel_isArchived_idx" ON "canvass"."Script"("organizationId", "channel", "isArchived");

-- CreateIndex
CREATE INDEX "ScriptStep_scriptId_parentStepId_orderIndex_idx" ON "canvass"."ScriptStep"("scriptId", "parentStepId", "orderIndex");

-- CreateIndex
CREATE INDEX "Survey_organizationId_isArchived_idx" ON "canvass"."Survey"("organizationId", "isArchived");
...
-- CreateIndex
CREATE INDEX "QuestionResponse_organizationId_contactId_createdAt_idx" ON "canvass"."QuestionResponse"("organizationId", "contactId", "createdAt");

-- CreateIndex
CREATE INDEX "QuestionResponse_questionId_optionId_idx" ON "canvass"."QuestionResponse"("questionId", "optionId");

-- CreateIndex
CREATE INDEX "DispositionDef_organizationId_layer_channel_idx" ON "canvass"."DispositionDef"("organizationId", "layer", "channel");

-- CreateIndex
CREATE UNIQUE INDEX "DispositionDef_organizationId_code_key" ON "canvass"."DispositionDef"("organizationId", "code");

-- CreateIndex
CREATE INDEX "Disposition_organizationId_contactId_createdAt_idx" ON "canvass"."Disposition"("organizationId", "contactId", "createdAt");

-- CreateIndex
CREATE INDEX "Disposition_organizationId_code_createdAt_idx" ON "canvass"."Disposition"("organizationId", "code", "createdAt");

-- CreateIndex
CREATE INDEX "CannedResponse_organizationId_channel_visibility_isArchived_idx" ON "canvass"."CannedResponse"("organizationId", "channel", "visibility", "isArchived");

-- CreateIndex
CREATE INDEX "CannedResponse_organizationId_ownerId_idx" ON "canvass"."CannedResponse"("organizationId", "ownerId");

-- CreateIndex
CREATE INDEX "Journey_organizationId_status_triggerType_idx" ON "journey"."Journey"("organizationId", "status", "triggerType");

-- CreateIndex
CREATE UNIQUE INDEX "JourneyRung_journeyId_rungIndex_key" ON "journey"."JourneyRung"("journeyId", "rungIndex");

-- CreateIndex
CREATE INDEX "JourneyEnrolment_organizationId_state_resumeAt_idx" ON "journey"."JourneyEnrolment"("organizationId", "state", "resumeAt");
...
-- CreateIndex
CREATE INDEX "CanvassCampaign_organizationId_status_idx" ON "canvass"."CanvassCampaign"("organizationId", "status");

-- CreateIndex
CREATE INDEX "Turf_organizationId_campaignId_idx" ON "canvass"."Turf"("organizationId", "campaignId");
...
-- CreateIndex
CREATE INDEX "WalkList_organizationId_campaignId_idx" ON "canvass"."WalkList"("organizationId", "campaignId");
...
-- CreateIndex
CREATE INDEX "DoorKnock_organizationId_contactId_createdAt_idx" ON "canvass"."DoorKnock"("organizationId", "contactId", "createdAt");

-- CreateIndex
CREATE INDEX "DoorKnock_canvasserId_createdAt_idx" ON "canvass"."DoorKnock"("canvasserId", "createdAt");

-- CreateIndex
CREATE UNIQUE INDEX "DoorKnock_organizationId_localId_key" ON "canvass"."DoorKnock"("organizationId", "localId");

-- CreateIndex
CREATE INDEX "Shift_organizationId_campaignId_startsAt_idx" ON "canvass"."Shift"("organizationId", "campaignId", "startsAt");

-- CreateIndex
CREATE INDEX "Shift_organizationId_canvasserId_idx" ON "canvass"."Shift"("organizationId", "canvasserId");

-- CreateIndex
CREATE INDEX "Suppression_organizationId_phoneE164_idx" ON "messaging"."Suppression"("organizationId", "phoneE164");

-- CreateIndex
CREATE INDEX "Suppression_organizationId_email_idx" ON "messaging"."Suppression"("organizationId", "email");
...
-- AddForeignKey
ALTER TABLE "Contact" ADD CONSTRAINT "Contact_organizationId_fkey" FOREIGN KEY ("organizationId") REFERENCES "tenant"."Organization"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "iam"."AppUser" ADD CONSTRAINT "AppUser_organizationId_fkey" FOREIGN KEY ("organizationId") REFERENCES "tenant"."Organization"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "audience"."Audience" ADD CONSTRAINT "Audience_organizationId_fkey" FOREIGN KEY ("organizationId") REFERENCES "tenant"."Organization"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "audience"."Audience" ADD CONSTRAINT "Audience_createdById_fkey" FOREIGN KEY ("createdById") REFERENCES "iam"."AppUser"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "messaging"."Blast" ADD CONSTRAINT "Blast_organizationId_fkey" FOREIGN KEY ("organizationId") REFERENCES "tenant"."Organization"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "messaging"."Blast" ADD CONSTRAINT "Blast_createdById_fkey" FOREIGN KEY ("createdById") REFERENCES "iam"."AppUser"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "messaging"."InboundMessage" ADD CONSTRAINT "InboundMessage_organizationId_fkey" FOREIGN KEY ("organizationId") REFERENCES "tenant"."Organization"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "messaging"."OutboundMessage" ADD CONSTRAINT "OutboundMessage_organizationId_fkey" FOREIGN KEY ("organizationId") REFERENCES "tenant"."Organization"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "messaging"."ContactConsent" ADD CONSTRAINT "ContactConsent_organizationId_fkey" FOREIGN KEY ("organizationId") REFERENCES "tenant"."Organization"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "messaging"."WhatsappTemplate" ADD CONSTRAINT "WhatsappTemplate_organizationId_fkey" FOREIGN KEY ("organizationId") REFERENCES "tenant"."Organization"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "integration"."IntegrationConnection" ADD CONSTRAINT "IntegrationConnection_organizationId_fkey" FOREIGN KEY ("organizationId") REFERENCES "tenant"."Organization"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "analytics"."AnalyticsSnapshot" ADD CONSTRAINT "AnalyticsSnapshot_organizationId_fkey" FOREIGN KEY ("organizationId") REFERENCES "tenant"."Organization"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "messaging"."ConversationState" ADD CONSTRAINT "ConversationState_organizationId_fkey" FOREIGN KEY ("organizationId") REFERENCES "tenant"."Organization"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "canvass"."Script" ADD CONSTRAINT "Script_organizationId_fkey" FOREIGN KEY ("organizationId") REFERENCES "tenant"."Organization"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "canvass"."Survey" ADD CONSTRAINT "Survey_organizationId_fkey" FOREIGN KEY ("organizationId") REFERENCES "tenant"."Organization"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "canvass"."QuestionResponse" ADD CONSTRAINT "QuestionResponse_organizationId_fkey" FOREIGN KEY ("organizationId") REFERENCES "tenant"."Organization"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "canvass"."DispositionDef" ADD CONSTRAINT "DispositionDef_organizationId_fkey" FOREIGN KEY ("organizationId") REFERENCES "tenant"."Organization"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "canvass"."Disposition" ADD CONSTRAINT "Disposition_organizationId_fkey" FOREIGN KEY ("organizationId") REFERENCES "tenant"."Organization"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "canvass"."CannedResponse" ADD CONSTRAINT "CannedResponse_organizationId_fkey" FOREIGN KEY ("organizationId") REFERENCES "tenant"."Organization"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "journey"."Journey" ADD CONSTRAINT "Journey_organizationId_fkey" FOREIGN KEY ("organizationId") REFERENCES "tenant"."Organization"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "canvass"."CanvassCampaign" ADD CONSTRAINT "CanvassCampaign_organizationId_fkey" FOREIGN KEY ("organizationId") REFERENCES "tenant"."Organization"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "canvass"."Turf" ADD CONSTRAINT "Turf_organizationId_fkey" FOREIGN KEY ("organizationId") REFERENCES "tenant"."Organization"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "canvass"."TurfAssignment" ADD CONSTRAINT "TurfAssignment_canvasserId_fkey" FOREIGN KEY ("canvasserId") REFERENCES "iam"."AppUser"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "canvass"."WalkList" ADD CONSTRAINT "WalkList_organizationId_fkey" FOREIGN KEY ("organizationId") REFERENCES "tenant"."Organization"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "canvass"."DoorKnock" ADD CONSTRAINT "DoorKnock_organizationId_fkey" FOREIGN KEY ("organizationId") REFERENCES "tenant"."Organization"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "canvass"."DoorKnock" ADD CONSTRAINT "DoorKnock_canvasserId_fkey" FOREIGN KEY ("canvasserId") REFERENCES "iam"."AppUser"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "canvass"."Shift" ADD CONSTRAINT "Shift_organizationId_fkey" FOREIGN KEY ("organizationId") REFERENCES "tenant"."Organization"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "messaging"."Suppression" ADD CONSTRAINT "Suppression_organizationId_fkey" FOREIGN KEY ("organizationId") REFERENCES "tenant"."Organization"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "PushSubscription" ADD CONSTRAINT "PushSubscription_organizationId_fkey" FOREIGN KEY ("organizationId") REFERENCES "tenant"."Organization"("id") ON DELETE CASCADE ON UPDATE CASCADE;


-- ─────────────────────────────────────────────────────────────────────────
-- geo layer: isolated geo schema + PostGIS (idempotent; preserved across resets)
-- ─────────────────────────────────────────────────────────────────────────
