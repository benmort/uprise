...
export interface KeypadProps {
  ...
  onBackspace: () => void;
  /** DTMF mode — a sent tone can't be unsent, so the ⌫ cell renders empty. */
  hideBackspace?: boolean;
  disabled?: boolean;
  className?: string;
}
 ...
 */
export function Keypad({ onKey, onBackspace, hideBackspace, disabled, className }: KeypadProps) {
  const key =
