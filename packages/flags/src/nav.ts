...
export const NAV_FLAGS = [
  ...
  // ── Second level: Future ────────────────────────────────────────────────
  { key: "FEATURE_NAV_PROG_CALENDAR", label: "Calendar", section: "Future", level: 2 },
  { key: "FEATURE_NAV_PROG_CHANNELS", label: "Future · Channels", section: "Future", level: 2 },
  { key: "FEATURE_NAV_PROG_ORGANISING", label: "Organising", section: "Future", level: 2 },
  { key: "FEATURE_NAV_PROG_TASKS", label: "Tasks", section: "Future", level: 2 },
  { key: "FEATURE_NAV_PROG_BUSINESS", label: "Business", section: "Future", level: 2 },
  { key: "FEATURE_NAV_PROG_WORKSPACE", label: "Workspace", section: "Future", level: 2 },
  { key: "FEATURE_NAV_PROG_DATA", label: "Data & Files", section: "Future", level: 2 },
  { key: "FEATURE_NAV_PROG_DEVHUB", label: "Developer Hub", section: "Future", level: 2 },
] as const;
